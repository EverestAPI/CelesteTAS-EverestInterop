...
internal static class TriggerHitbox {
    ...
    private static void Initialize() {
        ...
        AddModdedTypes("FrostHelper", "FrostHelper.Triggers.ArbitraryShapeCloudEditColorTrigger", "FrostHelper.Triggers.ArbitraryShapeCloudEditRainbowTrigger", "FrostHelper.BloomColorTrigger", "FrostHelper.BloomColorFadeTrigger", "FrostHelper.BloomColorPulseTrigger", "FrostHelper.RainbowBloomTrigger", "FrostHelper.Triggers.TimerEntity", "FrostHelper.Triggers.IncrementingTimerEntity", "FrostHelper.Triggers.CounterDisplayEntity", "FrostHelper.Triggers.LightingBaseColorTrigger", "FrostHelper.Triggers.LightningColorTrigger", "ColoredLights.FlashlightColorTrigger", "FrostHelper.FlashlightColorTrigger", "FrostHelper.Triggers.StylegroundBlendStateTrigger", "FrostHelper.Triggers.StylegroundMoveTrigger", "FrostHelper.BetterShaderTrigger"); // v1.65.0
