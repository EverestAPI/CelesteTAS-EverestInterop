...
public class InputCommands {
    ...
    [TASCommand(executeAtStart = true, args = new string[] {"Read, Path", "Read, Path, StartLine", "Read, Path, StartLine, EndLine"})]
    ...
    [TASCommand(illegalInMaingame = true,
        args = new string[] {
            "Console CommandType", "Console CommandType CommandArgs", "Console LoadCommand IDorSID", "Console LoadCommand IDorSID Screen",
            "Console LoadCommand IDorSID Screen Checkpoint", "Console LoadCommand IDorSID X Y"
        })]
    private static void ConsoleCommand(string[] args) {
        ConsoleHandler.ExecuteCommand(args);
    }

    [TASCommand(executeAtStart = true, args = new string[] {"Play, StartLine", "Play, StartLine, FramesToWait"})]
    ...
    [TASCommand(args = new string[] {"StartExport", "StartExport Path", "StartExport EntitiesToTrack", "StartExport Path EntitiesToTrack"})]
