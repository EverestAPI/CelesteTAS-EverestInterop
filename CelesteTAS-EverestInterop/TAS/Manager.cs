...
public static partial class Manager {
    ...
    public static void UpdateInputs() {
        ...
        if (HasFlag(state, State.Enable)) {
            ...
            */
                ...
                if ((lastOneFastForward || controller.Current.ForceBreak) && controller.Current.FastForward &&
    ...
    private static void BackupPlayerBindings() {
        ...
        Input.Jump.Nodes = new List<VirtualButton.Node>
            {new VirtualButton.PadButton(Input.Gamepad, Buttons.A), new VirtualButton.PadButton(Input.Gamepad, Buttons.Y)};
        Input.Dash.Nodes = new List<VirtualButton.Node>
            {new VirtualButton.PadButton(Input.Gamepad, Buttons.B), new VirtualButton.PadButton(Input.Gamepad, Buttons.X)};
