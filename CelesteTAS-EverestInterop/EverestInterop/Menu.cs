        ...
        private static void CreateOptions(EverestModule everestModule, TextMenu menu, bool inGame) {
            options = new List<TextMenu.Item> {
                new TextMenuExt.SubMenu("Show Hitboxes".ToDialogText(), false).Apply(subMenu => {
                    ...
                    subMenu.Add(new TextMenu.OnOff("Hide Trigger Hitboxes".ToDialogText(), Settings.HideTriggerHitboxes).Change(value => Settings.HideTriggerHitboxes = value));
                ...
                new TextMenuExt.SubMenu("More Options".ToDialogText(), false).Apply(subMenu => {
                    subMenu.Add(new TextMenu.OnOff("Center Camera".ToDialogText(), Settings.CenterCamera).Change(value => Settings.CenterCamera = value));
                    subMenu.Add(new TextMenu.OnOff("Round Position".ToDialogText(), Settings.RoundPosition).Change(value => Settings.RoundPosition = value));
                    ...
                    subMenu.Add(new TextMenu.OnOff("Pause After Load State".ToDialogText(), Settings.PauseAfterLoadState).Change(value => Settings.PauseAfterLoadState = value));
                    subMenu.Add(
                    ...
                    subMenu.Add(new TextMenu.OnOff("Auto Mute on Fast Forward".ToDialogText(), Settings.AutoMute).Change(value => Settings.AutoMute = value));
                    subMenu.Add(new TextMenu.OnOff("Mod 9D Lighting".ToDialogText(), Settings.Mod9DLighting).Change(value => Settings.Mod9DLighting = value));
                }),
